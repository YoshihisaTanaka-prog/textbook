class SolutionsController < ApplicationController
    ...
    respond_to do |format|
      if @solution.save
        if params[:selection]
          ...
          ss.selection_id = selection.id
          ss.solution_id = @solution.id
          ss.save
          format.html { redirect_to selection_url(selection), notice: "Solution was successfully created." }
  ...
  private
    ...
    def solution_params
      params.require(:solution).permit(:title, :kana, :content)
    end
end
