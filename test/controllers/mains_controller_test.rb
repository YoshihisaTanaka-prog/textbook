...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference("Main.count") do
      post mains_url, params: { main: { question: @main.question, selection_id: @main.selection_id, subject_id: @main.subject_id } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { question: @main.question, selection_id: @main.selection_id, subject_id: @main.subject_id } }
