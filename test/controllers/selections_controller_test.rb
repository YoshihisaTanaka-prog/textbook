...
class SelectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create selection" do
    assert_difference("Selection.count") do
      post selections_url, params: { selection: { main_id: @selection.main_id, text: @selection.text } }
    end
  ...
  test "should update selection" do
    patch selection_url(@selection), params: { selection: { main_id: @selection.main_id, text: @selection.text } }
